                ...
                <div className='flex flex-col lg:flex-row gap-x-10'>
                    <div className='flex-1 flex flex-col gap-y-12 mb-10 lg:mb-0'>
                        ...
                        >
                            ...
                            <div className='absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50 mb-16'><span className='text-gradient mr-6'>Capture Academy</span></div>
                            <div className='absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50'><span className='text-sm text-white'> Developed a visually captivating website theme focused on
                                photography education and summer camp, creating an immersive and engaging
                                experience for visitors</span> <br />
                                <span className='bg-accent py-2 px-3 rounded-lg'><a href="https://capture-academy-1a91f.web.app/">Preview</a></span>
                            </div>
                        </div>
                    </div>
                    <div className='flex-1 flex flex-col gap-y-12 '>
                        ...
                        <div className="group relative overflow-hidden border-2 border-white/50 rounded-xl" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 text-center md:left-12 group-hover:bottom-10 transition-all duration-700 z-50 md:text-left opacity-0 group-hover:opacity-100">
                                <span className="text-sm text-white">
                                    Create an exclusive online platform dedicated to Thai cuisine, offering a
                                    wide range of authentic Thai recipes and culinary inspiration.
                                </span>
                                <br />
                                <span className="bg-accent py-2 px-3 rounded-lg">
